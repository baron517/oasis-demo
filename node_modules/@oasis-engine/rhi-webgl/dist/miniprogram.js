...
var WebCanvas = /*#__PURE__*/function () {
  ...
  _proto.resizeByClientSize = function resizeByClientSize(pixelRatio) {
    ...
    if (typeof miniprogramAdapter.OffscreenCanvas === "undefined" || !(webCanvas instanceof miniprogramAdapter.OffscreenCanvas)) {
  ...
  _createClass(WebCanvas, [{
    ...
    get: function get() {
      var webCanvas = this._webCanvas;
      if (typeof miniprogramAdapter.OffscreenCanvas === "undefined" || !(webCanvas instanceof miniprogramAdapter.OffscreenCanvas)) {
        this._scale.set(webCanvas.clientWidth * miniprogramAdapter.devicePixelRatio / webCanvas.width, webCanvas.clientHeight * miniprogramAdapter.devicePixelRatio / webCanvas.height);
      }
      return this._scale;
    },
    set: function set(value) {
...
var GLRenderTarget = /*#__PURE__*/function () {
  ...
  function GLRenderTarget(rhi, target) {
    ...
    var isDepthTexture = _depth instanceof miniprogram$1.Texture;
    ...
    if (_colorTextures.length > 1 && _colorTextures.some(function (v) {
      return v instanceof miniprogram$1.TextureCube;
    })) {
  ...
  _proto.setRenderTargetInfo = function setRenderTargetInfo(faceIndex, mipLevel) {
    ...
    if (colorTexture) {
      var isCube = colorTexture instanceof miniprogram$1.TextureCube;
    ...
    if (depthTexture) {
      var _isCube = depthTexture instanceof miniprogram$1.TextureCube;
  ...
  _proto._bindMainFBO = function _bindMainFBO() {
    ...
    for (var i = 0; i < colorTextureCount; i++) {
      ...
      if (!(colorTexture instanceof miniprogram$1.TextureCube)) {
    ...
    /** depth render buffer */
    if (_depth !== null) {
      if (_depth instanceof miniprogram$1.Texture) {
        if (!(_depth instanceof miniprogram$1.TextureCube)) {
  ...
  _proto._bindMSAAFBO = function _bindMSAAFBO() {
    ...
    if (_depth !== null) {
      var _ref = _depth instanceof miniprogram$1.Texture ? /** @ts-ignore */
...
var WebGLRenderer = /*#__PURE__*/function () {
  ...
  _proto.init = function init(canvas) {
    ...
    if (webGLMode == exports.WebGLMode.Auto || webGLMode == exports.WebGLMode.WebGL2) {
      ...
      if (!gl && (typeof miniprogramAdapter.OffscreenCanvas === "undefined" || !(webCanvas instanceof miniprogramAdapter.OffscreenCanvas))) {
