...
var GLTexture = /*#__PURE__*/function () {
  ...
  GLTexture._getFormatDetail = function _getFormatDetail(format, gl, isWebGL2) {
    switch (format) {
      ...
      case core.TextureFormat.R16G16B16A16:
        return {
  ...
  GLTexture._getRenderBufferDepthFormatDetail = function _getRenderBufferDepthFormatDetail(format, gl, isWebGL2) {
    switch (format) {
      ...
      case core.TextureFormat.DepthStencil:
      ...
      case core.TextureFormat.Stencil:
      ...
      case core.TextureFormat.Depth32:
      ...
      case core.TextureFormat.Depth32Stencil8:
  ...
  GLTexture._supportTextureFormat = function _supportTextureFormat(format, rhi) {
    ...
    switch (format) {
      case core.TextureFormat.R16G16B16A16:
        {
          if (!rhi.canIUse(core.GLCapabilityType.textureHalfFloat)) {
            isSupported = false;
          }
        }
        break;
...
var GLRenderTarget = /*#__PURE__*/function () {
  ...
  function GLRenderTarget(rhi, target) {
    ...
    var isDepthTexture = _depth instanceof core.Texture;
    ...
    for (var i = 0, n = _colorTextures.length; i < n; i++) {
      ...
      if (!GLTexture._supportRenderBufferColorFormat(format, rhi)) {
        throw new Error("TextureFormat is not supported:" + core.TextureFormat[format] + " in RenderTarget");
      }
    }
    if (!GLTexture._supportRenderBufferDepthFormat(isDepthTexture ? _depth.format : _depth, rhi, isDepthTexture)) {
      throw new Error("TextureFormat is not supported:" + core.TextureFormat[_depth] + " in RenderTarget");
    }
    ...
    if (_colorTextures.length > 1 && _colorTextures.some(function (v) {
      return v instanceof core.TextureCube;
    })) {
  ...
  _proto.setRenderTargetInfo = function setRenderTargetInfo(faceIndex, mipLevel) {
    ...
    if (colorTexture) {
      var isCube = colorTexture instanceof core.TextureCube;
    ...
    if (depthTexture) {
      var _isCube = depthTexture instanceof core.TextureCube;
  ...
  _proto._bindMainFBO = function _bindMainFBO() {
    ...
    for (var i = 0; i < colorTextureCount; i++) {
      ...
      if (!(colorTexture instanceof core.TextureCube)) {
    ...
    /** depth render buffer */
    if (_depth !== null) {
      if (_depth instanceof core.Texture) {
        if (!(_depth instanceof core.TextureCube)) {
  ...
  _proto._bindMSAAFBO = function _bindMSAAFBO() {
    ...
    if (_depth !== null) {
      var _ref = _depth instanceof core.Texture ? /** @ts-ignore */
...
var WebGLRenderer = /*#__PURE__*/function () {
  ...
  _proto.clearRenderTarget = function clearRenderTarget(engine, clearFlags, clearColor) {
    ...
    var clearFlag = 0;
    if (clearFlags & core.CameraClearFlags.Color) {
    ...
    if (clearFlags & core.CameraClearFlags.Depth) {
    ...
    if (clearFlags & core.CameraClearFlags.Stencil) {
