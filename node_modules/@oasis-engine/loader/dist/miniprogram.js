    ...
    return new miniprogram.AssetPromise(function (resolve, reject) {
      _this.request(item.url, _objectSpread2(_objectSpread2({}, item), {}, {
        ...
        var _loop = function _loop(_key) {
          ...
          switch (type) {
            case "Vector2":
              materialShaderData.setVector2(_key, new miniprogram$1.Vector2(value.x, value.y));
              break;
            case "Vector3":
              materialShaderData.setVector3(_key, new miniprogram$1.Vector3(value.x, value.y, value.z));
              break;
            case "Vector4":
              materialShaderData.setVector4(_key, new miniprogram$1.Vector4(value.x, value.y, value.z, value.w));
              break;
            case "Color":
              materialShaderData.setColor(_key, new miniprogram$1.Color(value.r, value.g, value.b, value.a));
              break;
            case "Float":
        ...
        img.onload = function () {
          ...
          if (mipmap) {
            ...
            var _loop = function _loop(_i) {
              var blob = new miniprogramAdapter.window.Blob([imagesData[_i]]);
              var img = new miniprogramAdapter.Image();
              img.onload = function () {
...
var _dec$3, _class$3;
var EditorTextureLoader = (_dec$3 = miniprogram.resourceLoader("EditorTexture2D", ["prefab"], true), _dec$3(_class$3 = /*#__PURE__*/function (_Loader) {
...
var _dec$2, _class$2;
(_dec$2 = miniprogram.resourceLoader(miniprogram.AssetType.Mesh, ["mesh"]), _dec$2(_class$2 = /*#__PURE__*/function (_Loader) {
  _inheritsLoose(MeshLoader, _Loader);
  function MeshLoader() {
    return _Loader.apply(this, arguments) || this;
  }
...
var _dec$1, _class$1;
(_dec$1 = miniprogram.resourceLoader(miniprogram.AssetType.AnimatorController, ["json"], false), _dec$1(_class$1 = /*#__PURE__*/function (_Loader) {
...
}(miniprogram.Loader)) || _class$1);

var _dec, _class;
(_dec = miniprogram.resourceLoader(miniprogram.AssetType.Scene, ["prefab"], true), _dec(_class = /*#__PURE__*/function (_Loader) {
