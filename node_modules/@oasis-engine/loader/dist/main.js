...
(_dec$r = core.resourceLoader(core.AssetType.Buffer, ["bin", "r3bin"], false), _dec$r(_class$r = /*#__PURE__*/function (_Loader) {
    ...
    for (var i = 0; i < gltf.materials.length; i++) {
      ...
      if (!KHR_materials_unlit) {
        ...
        if (occlusionTexture) {
          ...
          if (texCoord === core.TextureCoordinate.UV1) {
            _m.occlusionTextureCoord = core.TextureCoordinate.UV1;
          } else if (texCoord > core.TextureCoordinate.UV1) {
            core.Logger.warn("Occlusion texture uv coordinate must be UV0 or UV1.");
          }
        }
      }
...
var _dec$q, _class$q;
(_dec$q = core.resourceLoader(core.AssetType.Prefab, ["gltf", "glb"]), _dec$q(_class$q = /*#__PURE__*/function (_Loader) {
  ...
  return GLTFLoader;
}(core.Loader)) || _class$q);

var _dec$p, _class$p;
(_dec$p = core.resourceLoader(core.AssetType.JSON, ["json"], false), _dec$p(_class$p = /*#__PURE__*/function (_Loader) {
...
var _dec$o, _class$o;
(_dec$o = core.resourceLoader(core.AssetType.KTXCube, []), _dec$o(_class$o = /*#__PURE__*/function (_Loader) {
  ...
  _proto.load = function load(item, resourceManager) {
    ...
    return new core.AssetPromise(function (resolve, reject) {
      Promise.all(item.urls.map(function (url) {
        ...
        var texture = new core.TextureCube(resourceManager.engine, width, engineFormat, mipmap);
...
}(core.Loader)) || _class$o);

var _dec$n, _class$n;
(_dec$n = core.resourceLoader(core.AssetType.KTX, ["ktx"]), _dec$n(_class$n = /*#__PURE__*/function (_Loader) {
  ...
  return KTXLoader;
}(core.Loader)) || _class$n);

var _dec$m, _class$m;
(_dec$m = core.resourceLoader(core.AssetType.Texture2D, ["png", "jpg", "webp", "jpeg"]), _dec$m(_class$m = /*#__PURE__*/function (_Loader) {
...
}(core.Loader)) || _class$m);

var _dec$l, _class$l;
(_dec$l = core.resourceLoader(core.AssetType.TextureCube, [""]), _dec$l(_class$l = /*#__PURE__*/function (_Loader) {
  ...
  _proto.load = function load(item, resourceManager) {
    ...
    return new core.AssetPromise(function (resolve, reject) {
      Promise.all(item.urls.map(function (url) {
        ...
        var tex = new core.TextureCube(resourceManager.engine, width);
...
}(core.Loader)) || _class$l);

var _dec$k, _class$k;
(_dec$k = core.resourceLoader(core.AssetType.Sprite, ["sprite"], false), _dec$k(_class$k = /*#__PURE__*/function (_Loader) {
    ...
    return new core.AssetPromise(function (resolve, reject) {
      _this.request(item.url, _objectSpread2(_objectSpread2({}, item), {}, {
        ...
        resourceManager.getResourceByRef(data.texture).then(function (texture) {
          var sprite = new core.Sprite(resourceManager.engine, texture);
...
var _dec$j, _class$j;
(_dec$j = core.resourceLoader(core.AssetType.SpriteAtlas, ["atlas"], false), _dec$j(_class$j = /*#__PURE__*/function (_Loader) {
  ...
  function SpriteAtlasLoader() {
    ...
    _this._tempRect = new math.Rect();
    _this._tempVec2 = new math.Vector2();
    return _this;
  }
        ...
        Promise.all(atlasItems.map(function (_ref) {
          ...
          for (var i = 0; i < atlasItemsLen; i++) {
            ...
            for (var j = sprites.length - 1; j >= 0; j--) {
              ...
              var sprite = new core.Sprite(engine, texture, region ? tempRect.set(region.x, region.y, region.w, region.h) : undefined, pivot ? tempVec2.set(pivot.x, pivot.y) : undefined, undefined, atlasSprite.name);
...
var _dec$i, _class$i;
(_dec$i = core.resourceLoader(core.AssetType.Env, ["env"]), _dec$i(_class$i = /*#__PURE__*/function (_Loader) {
  ...
  _proto.load = function load(item, resourceManager) {
    ...
    return new core.AssetPromise(function (resolve, reject) {
      _this.request(item.url, {
        ...
        var texture = new core.TextureCube(resourceManager.engine, size);
...
var PI = Math.PI;
(_dec$h = core.resourceLoader(core.AssetType.HDR, ["hdr"]), _dec$h(_class$h = (_class2$1 = /*#__PURE__*/function (_Loader) {
  ...
  _proto.load = function load(item, resourceManager) {
    ...
    return new core.AssetPromise(function (resolve, reject) {
      ...
      _this.request(item.url, {
        ...
        var texture = new core.TextureCube(engine, cubeSize);
        for (var faceIndex = 0; faceIndex < 6; faceIndex++) {
          texture.setPixelBuffer(core.TextureCubeFace.PositiveX + faceIndex, cubeMapData[faceIndex], 0);
        }
        texture.generateMipmaps();
        resolve(texture);
      }).catch(reject);
  ...
  return HDRLoader;
}(core.Loader), _class2$1._rightBottomBack = new math.Vector3(1.0, -1.0, -1.0), _class2$1._rightBottomFront = new math.Vector3(1.0, -1.0, 1.0), _class2$1._rightUpBack = new math.Vector3(1.0, 1.0, -1.0), _class2$1._rightUpFront = new math.Vector3(1.0, 1.0, 1.0), _class2$1._leftBottomBack = new math.Vector3(-1.0, -1.0, -1.0), _class2$1._leftBottomFront = new math.Vector3(-1.0, -1.0, 1.0), _class2$1._leftUpBack = new math.Vector3(-1.0, 1.0, -1.0), _class2$1._leftUpFront = new math.Vector3(-1.0, 1.0, 1.0), _class2$1._faceRight = [_class2$1._rightBottomBack, _class2$1._rightBottomFront, _class2$1._rightUpBack, _class2$1._rightUpFront], _class2$1._faceLeft = [_class2$1._leftBottomFront, _class2$1._leftBottomBack, _class2$1._leftUpFront, _class2$1._leftUpBack], _class2$1._faceUp = [_class2$1._leftBottomFront, _class2$1._rightBottomFront, _class2$1._leftBottomBack, _class2$1._rightBottomBack], _class2$1._faceBottom = [_class2$1._leftUpBack, _class2$1._rightUpBack, _class2$1._leftUpFront, _class2$1._rightUpFront], _class2$1._faceFront = [_class2$1._leftBottomBack, _class2$1._rightBottomBack, _class2$1._leftUpBack, _class2$1._rightUpBack], _class2$1._faceBack = [_class2$1._rightBottomFront, _class2$1._leftBottomFront, _class2$1._rightUpFront, _class2$1._leftUpFront], _class2$1._tempVector3 = new math.Vector3(), _class2$1._temp2Vector3 = new math.Vector3(), _class2$1._temp3Vector3 = new math.Vector3(), _class2$1._temp4Vector3 = new math.Vector3(), _class2$1._temp5Vector3 = new math.Vector3(), _class2$1)) || _class$h);
...
var _dec$7, _class$7;
(_dec$7 = core.resourceLoader(core.AssetType.Material, ["json"]), _dec$7(_class$7 = /*#__PURE__*/function (_Loader) {
      ...
      _this.request(item.url, _objectSpread2(_objectSpread2({}, item), {}, {
        ...
        switch (shader) {
          ...
          case "unlit":
            ...
            break;
          case "blinn-phong":
            material = new core.BlinnPhongMaterial(engine);
            break;
        }
        ...
        var _loop = function _loop(_key) {
          ...
          switch (type) {
            case "Vector2":
              materialShaderData.setVector2(_key, new math.Vector2(value.x, value.y));
              break;
            case "Vector3":
              materialShaderData.setVector3(_key, new math.Vector3(value.x, value.y, value.z));
              break;
            case "Vector4":
              materialShaderData.setVector4(_key, new math.Vector4(value.x, value.y, value.z, value.w));
              break;
            case "Color":
              materialShaderData.setColor(_key, new math.Color(value.r, value.g, value.b, value.a));
              break;
            case "Float":
...
var MeshDecoder = (_dec$6 = decoder("Mesh"), _dec$6(_class$6 = /*#__PURE__*/function () {
  ...
  MeshDecoder.decode = function decode(engine, bufferReader) {
    return new Promise(function (resolve) {
      var modelMesh = new core.ModelMesh(engine);
      ...
      if (encodedMeshData.blendShapes) {
        encodedMeshData.blendShapes.forEach(function (blendShapeData) {
          var blendShape = new core.BlendShape(blendShapeData.name);
...
function float32ArrayToVColor(float32Array, vertexCount) {
  ...
  for (var i = 0; i < vertexCount; i++) {
    array[i] = new math.Color(float32Array[i * 4], float32Array[i * 4 + 1], float32Array[i * 4 + 2], float32Array[i * 4 + 3]);
  }
  return array;
}
function float32ArrayToVector4(float32Array, vertexCount) {
  var array = new Array(vertexCount);
  for (var i = 0; i < vertexCount; i++) {
    array[i] = new math.Vector4(float32Array[i * 4], float32Array[i * 4 + 1], float32Array[i * 4 + 2], float32Array[i * 4 + 3]);
  }
  return array;
}
function float32ArrayToVector3(float32Array, vertexCount) {
  var array = new Array(vertexCount);
  for (var i = 0; i < vertexCount; i++) {
    array[i] = new math.Vector3(float32Array[i * 3], float32Array[i * 3 + 1], float32Array[i * 3 + 2]);
  }
  return array;
}
function float32ArrayToVector2(float32Array, vertexCount) {
  var array = new Array(vertexCount);
  for (var i = 0; i < vertexCount; i++) {
    array[i] = new math.Vector2(float32Array[i * 2], float32Array[i * 2 + 1]);
  }
  return array;
}
...
var Texture2DDecoder = (_dec$5 = decoder("Texture2D"), _dec$5(_class$5 = /*#__PURE__*/function () {
  ...
  Texture2DDecoder.decode = function decode(engine, bufferReader) {
    return new Promise(function (resolve, reject) {
      ...
      var texture2D = new core.Texture2D(engine, width, height, format, mipmap);
...
var ReflectionParser = /*#__PURE__*/function () {
  ...
  ReflectionParser.parseEntity = function parseEntity(entityConfig, engine) {
    ...
    return ReflectionParser.getEntityByConfig(entityConfig, engine).then(function (entity) {
      ...
      for (var i = 0; i < entityConfig.components.length; i++) {
        ...
        if (key === "Animator") {
          component = entity.getComponent(core.Loader.getClass(key));
        }
        component = component || entity.addComponent(core.Loader.getClass(key));
  ...
  ReflectionParser.getEntityByConfig = function getEntityByConfig(entityConfig, engine) {
    ...
    if (assetRefId) {
      ...
      var entity = new core.Entity(engine, entityConfig.name);
  ...
  ReflectionParser.parseClassObject = function parseClassObject(item, engine, resourceManager) {
    ...
    var Class = core.Loader.getClass(item.class);
...
var _dec$4, _class$4;
var MeshLoader = (_dec$4 = core.resourceLoader("Mesh", ["prefab"], true), _dec$4(_class$4 = /*#__PURE__*/function (_Loader) {
...
var _dec$3, _class$3;
var EditorTextureLoader = (_dec$3 = core.resourceLoader("EditorTexture2D", ["prefab"], true), _dec$3(_class$3 = /*#__PURE__*/function (_Loader) {
...
var _dec$2, _class$2;
(_dec$2 = core.resourceLoader(core.AssetType.Mesh, ["mesh"]), _dec$2(_class$2 = /*#__PURE__*/function (_Loader) {
  _inheritsLoose(MeshLoader, _Loader);
  function MeshLoader() {
    return _Loader.apply(this, arguments) || this;
  }
...
var _dec$1, _class$1;
(_dec$1 = core.resourceLoader(core.AssetType.AnimatorController, ["json"], false), _dec$1(_class$1 = /*#__PURE__*/function (_Loader) {
          ...
          return _regeneratorRuntime().wrap(function _callee2$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  animatorController = new core.AnimatorController();
                  layers = data.layers;
                  promises = [];
                  layers.forEach(function (layerData, layerIndex) {
                    ...
                    if (stateMachineData) {
                      ...
                      var stateMachine = layer.stateMachine = new core.AnimatorStateMachine();
                      ...
                      states.forEach(function (stateData) {
                        ...
                        transitions.forEach(function (transitionData) {
                          ...
                          var transition = new core.AnimatorStateTransition();
...
}(core.Loader)) || _class$1);

var _dec, _class;
(_dec = core.resourceLoader(core.AssetType.Scene, ["prefab"], true), _dec(_class = /*#__PURE__*/function (_Loader) {
      ...
      return _this.request(item.url, {
        ...
        return SceneParser.parse(engine, data).then(function (scene) {
          ...
          switch (scene.background.mode) {
            case core.BackgroundMode.SolidColor:
              scene.background.solidColor.copyFrom(background.color);
              break;
            case core.BackgroundMode.Sky:
              if (background.sky) {
                backgroundPromise = resourceManager.getResourceByRef(background.sky).then(function (light) {
                  var sky = scene.background.sky;
                  var skyMaterial = new core.SkyBoxMaterial(engine);
                  skyMaterial.textureCubeMap = light.specularTexture;
                  skyMaterial.textureDecodeRGBM = true;
                  sky.material = skyMaterial;
                  sky.mesh = core.PrimitiveMesh.createCuboid(engine, 1, 1, 1);
                });
              }
              break;
            case core.BackgroundMode.Texture:
