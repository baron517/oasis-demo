...
var Transform = (_class$d = (_class2$b = /*#__PURE__*/function (_Component) {
  ...
  _proto.lookAt = function lookAt(targetPosition, worldUp) {
    ...
    miniprogram.Vector3.subtract(this.worldPosition, targetPosition, zAxis);
    var axisLen = zAxis.length();
    if (axisLen <= miniprogram.MathUtil.zeroTolerance) {
    ...
    if (worldUp) {
      miniprogram.Vector3.cross(worldUp, zAxis, xAxis);
    } else {
  ...
  _proto._rotateByQuat = function _rotateByQuat(rotateQuat, relativeToLocal) {
    if (relativeToLocal) {
      ...
      miniprogram.Quaternion.multiply(rotateQuat, this.worldRotationQuaternion, this._worldRotationQuaternion);
    }
  };
  ...
  _proto._onWorldPositionChanged = function _onWorldPositionChanged() {
    ...
    if (parent) {
      ...
      miniprogram.Vector3.transformCoordinate(worldPosition, Transform._tempMat41, this._position);
    } else {
  ...
  _proto._onWorldRotationChanged = function _onWorldRotationChanged() {
    ...
    miniprogram.Quaternion.rotationEuler(miniprogram.MathUtil.degreeToRadian(worldRotation.x), miniprogram.MathUtil.degreeToRadian(worldRotation.y), miniprogram.MathUtil.degreeToRadian(worldRotation.z), this._worldRotationQuaternion);
  ...
  _proto._onWorldRotationQuaternionChanged = function _onWorldRotationQuaternionChanged() {
    ...
    if (parent) {
      ...
      miniprogram.Quaternion.invert(parent.worldRotationQuaternion, invParentQuaternion);
      miniprogram.Quaternion.multiply(invParentQuaternion, worldRotationQuaternion, this._rotationQuaternion);
    } else {
  ...
  _createClass(Transform, [{
    ...
    get: function get() {
      ...
      if (this._isContainDirtyFlag(TransformFlag.LocalEuler)) {
        ...
        rotation.scale(miniprogram.MathUtil.radToDegreeFactor); // radians to degrees
        this._setDirtyFlagFalse(TransformFlag.LocalEuler);
      }
      return rotation;
    },
    ...
    get: function get() {
      ...
      if (this._isContainDirtyFlag(TransformFlag.WorldEuler)) {
        ...
        worldRotation.scale(miniprogram.MathUtil.radToDegreeFactor); // Radian to angle
        //@ts-ignore
    ...
    get: function get() {
      ...
      if (this._isContainDirtyFlag(TransformFlag.LocalQuat)) {
        ...
        miniprogram.Quaternion.rotationEuler(miniprogram.MathUtil.degreeToRadian(this._rotation.x), miniprogram.MathUtil.degreeToRadian(this._rotation.y), miniprogram.MathUtil.degreeToRadian(this._rotation.z), rotationQuaternion);
        //@ts-ignore
    ...
    set: function set(value) {
      if (this._rotationQuaternion !== value) {
        if (value.normalized) {
          ...
          miniprogram.Quaternion.normalize(value, this._rotationQuaternion);
        }
      } else {
    ...
    get: function get() {
      ...
      if (this._isContainDirtyFlag(TransformFlag.WorldQuat)) {
        ...
        var parent = this._getParentTransform();
        if (parent != null) {
          miniprogram.Quaternion.multiply(parent.worldRotationQuaternion, this.rotationQuaternion, worldRotationQuaternion);
        } else {
    ...
    set: function set(value) {
      if (this._worldRotationQuaternion !== value) {
        if (value.normalized) {
          ...
          miniprogram.Quaternion.normalize(value, this._worldRotationQuaternion);
        }
      }
      value.normalized || value.normalize();
    }
    ...
    set: function set(value) {
      ...
      if (parent) {
        ...
        miniprogram.Matrix.multiply(Transform._tempMat42, value, this._localMatrix);
      } else {
        this._localMatrix.copyFrom(value);
      }
  ...
  return Transform;
}(Component), _class2$b._tempQuat0 = new miniprogram.Quaternion(), _class2$b._tempVec30 = new miniprogram.Vector3(), _class2$b._tempVec31 = new miniprogram.Vector3(), _class2$b._tempVec32 = new miniprogram.Vector3(), _class2$b._tempMat30 = new miniprogram.Matrix3x3(), _class2$b._tempMat31 = new miniprogram.Matrix3x3(), _class2$b._tempMat32 = new miniprogram.Matrix3x3(), _class2$b._tempMat41 = new miniprogram.Matrix(), _class2$b._tempMat42 = new miniprogram.Matrix(), _class2$b), (_descriptor$a = _applyDecoratedDescriptor(_class$d.prototype, "_position", [deepClone], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
var DynamicCollider = /*#__PURE__*/function (_Collider) {
  ...
  function DynamicCollider(entity) {
    ...
    _this._angularVelocity = new miniprogram.Vector3();
    _this._mass = 0;
    _this._centerOfMass = new miniprogram.Vector3();
    _this._inertiaTensor = new miniprogram.Vector3();
    ...
    _this._collisionDetectionMode = exports.CollisionDetectionMode.Discrete;
    var transform = _this.entity.transform;
...
var PointerManager = /*#__PURE__*/function () {
  ...
  function PointerManager(engine, htmlCanvas) {
    this._pointers = [];
    this._movingDelta = new miniprogram.Vector2();
  ...
  _proto._removePointer = function _removePointer(pointerIndex) {
    ...
    leavePointer.phase = exports.PointerPhase.Leave;
  };
  ...
  _proto._handlePointerEvent = function _handlePointerEvent(nativeEvents, frameCount) {
    ...
    for (var i = 0; i < nativeEventsLen; i++) {
      var evt = nativeEvents[i];
      var pointerButton = evt.button | exports.PointerButton.Primary;
      var pointerIndex = this._getIndexByPointerID(evt.pointerId);
      switch (evt.type) {
        case "pointerdown":
          if (pointerIndex === -1) {
            this._addPointer(evt.pointerId, evt.offsetX * pixelRatioW, evt.offsetY * pixelRatioH, exports.PointerPhase.Down);
            activePointerCount++;
          } else {
            this._updatePointer(pointerIndex, evt.offsetX * pixelRatioW, evt.offsetY * pixelRatioH, exports.PointerPhase.Down);
          }
        ...
        case "pointerup":
          if (pointerIndex >= 0) {
            this._updatePointer(pointerIndex, evt.offsetX * pixelRatioW, evt.offsetY * pixelRatioH, exports.PointerPhase.Up);
        ...
        case "pointermove":
          if (pointerIndex === -1) {
            this._addPointer(evt.pointerId, evt.offsetX * pixelRatioW, evt.offsetY * pixelRatioH, exports.PointerPhase.Move);
            activePointerCount++;
          } else {
            this._updatePointer(pointerIndex, evt.offsetX * pixelRatioW, evt.offsetY * pixelRatioH, exports.PointerPhase.Move);
          }
          break;
        case "pointerout":
          if (pointerIndex >= 0) {
    ...
    if (this._pointers.length > 0) {
      ...
      for (var i = cameras.length - 1; i >= 0; i--) {
        ...
        if (x >= vpX && y >= vpY && x - vpX <= vpW && y - vpY <= vpH) {
          ...
          } else if (camera.clearFlags & exports.CameraClearFlags.Color) {
            return null;
          }
        }
      }
...
var WheelManager = /*#__PURE__*/function () {
  ...
  function WheelManager(htmlCanvas) {
    this._delta = new miniprogram.Vector3();
    this._nativeEvents = [];
    this._canvas = void 0;
...
var InputManager = /*#__PURE__*/function () {
  ...
  function InputManager(engine) {
    ...
    if (typeof miniprogramAdapter.OffscreenCanvas === "undefined" || !(canvas instanceof miniprogramAdapter.OffscreenCanvas)) {
      ...
      miniprogramAdapter.window.addEventListener("blur", this._onBlur);
      this._onFocus = this._onFocus.bind(this);
      miniprogramAdapter.window.addEventListener("focus", this._onFocus);
      this._initialized = true;
    }
  }
  ...
  _proto._destroy = function _destroy() {
    if (this._initialized) {
      miniprogramAdapter.window.removeEventListener("blur", this._onBlur);
      miniprogramAdapter.window.removeEventListener("focus", this._onFocus);
...
var ShaderData = /*#__PURE__*/function () {
  ...
  _proto.setFloat = function setFloat(property, value) {
    this._setPropertyValue(property, exports.ShaderPropertyType.Float, value);
  }
  ...
  _proto.setInt = function setInt(property, value) {
    this._setPropertyValue(property, exports.ShaderPropertyType.Int, value);
  }
  ...
  _proto.setFloatArray = function setFloatArray(property, value) {
    this._setPropertyValue(property, exports.ShaderPropertyType.FloatArray, value);
  }
  ...
  _proto.setIntArray = function setIntArray(property, value) {
    this._setPropertyValue(property, exports.ShaderPropertyType.IntArray, value);
  }
  ...
  _proto.setVector2 = function setVector2(property, value) {
    this._setPropertyValue(property, exports.ShaderPropertyType.Vector2, value);
  }
  ...
  _proto.setVector3 = function setVector3(property, value) {
    this._setPropertyValue(property, exports.ShaderPropertyType.Vector3, value);
  }
  ...
  _proto.setVector4 = function setVector4(property, value) {
    this._setPropertyValue(property, exports.ShaderPropertyType.Vector4, value);
  }
  ...
  _proto.setMatrix = function setMatrix(property, value) {
    this._setPropertyValue(property, exports.ShaderPropertyType.Matrix, value);
  }
  ...
  _proto.setColor = function setColor(property, value) {
    this._setPropertyValue(property, exports.ShaderPropertyType.Color, value);
  }
  ...
  _proto.setTextureArray = function setTextureArray(property, value) {
    ...
    this._setPropertyValue(property, exports.ShaderPropertyType.TextureArray, value);
  }
  ...
  _proto._setPropertyValue = function _setPropertyValue(property, type, value) {
    ...
    if (property._type !== type) {
      if (property._type === undefined) {
        ...
        throw "Shader property " + property.name + " has been used as " + exports.ShaderPropertyType[property._type] + " type.";
      }
    }
...
var Renderer = (_dec$3 = dependentComponents(Transform), _dec$3(_class$a = (_class2$9 = (_class3$1 = /*#__PURE__*/function (_Component) {
  ...
  writable: true,
  initializer: function initializer() {
    return new miniprogram.BoundingBox();
  }
...
var SimpleSpriteAssembler = (_dec$2 = StaticInterfaceImplement(), _dec$2(_class$9 = (_class2$8 = /*#__PURE__*/function () {
  ...
  SimpleSpriteAssembler.updatePositions = function updatePositions(renderer) {
    ...
    miniprogram.BoundingBox.transform(sprite._getBounds(), worldMatrix, renderer._bounds);
  };
...
}(), _class2$8._rectangleTriangles = [0, 1, 2, 2, 1, 3], _class2$8._worldMatrix = new miniprogram.Matrix(), _class2$8)) || _class$9);
...
var BlendShapeManager = /*#__PURE__*/function () {
  ...
  function BlendShapeManager(engine, modelMesh) {
    ...
    this._lastCreateHostInfo = new miniprogram.Vector3(0, 0, 0);
    this._canUseTextureStoreData = true;
    this._dataTextureInfo = new miniprogram.Vector3();
    this._engine = engine;
  ...
  _proto._addVertexElements = function _addVertexElements(modelMesh) {
    ...
    for (var i = 0, n = Math.min(this._blendShapeCount, this._getVertexBufferModeSupportCount()); i < n; i++) {
      modelMesh._addVertexElement(new VertexElement("POSITION_BS" + i, offset, exports.VertexElementFormat.Vector3, 1));
      offset += 12;
      if (this._useBlendNormal) {
        modelMesh._addVertexElement(new VertexElement("NORMAL_BS" + i, offset, exports.VertexElementFormat.Vector3, 1));
        offset += 12;
      }
      if (this._useBlendTangent) {
        modelMesh._addVertexElement(new VertexElement("TANGENT_BS" + i, offset, exports.VertexElementFormat.Vector3, 1));
        offset += 12;
      }
    }
  }
  ...
  _proto._createVertexBuffers = function _createVertexBuffers(vertexCount, noLongerAccessible) {
    ...
    for (var i = 0; i < bufferCount; i++) {
      ...
      var usage = noLongerAccessible ? exports.BufferUsage.Static : exports.BufferUsage.Dynamic;
      var blendShapeBuffer = new Buffer(engine, exports.BufferBindFlag.VertexBuffer, byteLength, usage);
  ...
  _proto._createTextureArray = function _createTextureArray(vertexCount) {
    ...
    blendShapeDataTexture = new Texture2DArray(this._engine, textureWidth, textureHeight, blendShapeCount, exports.TextureFormat.R32G32B32A32, false);
    blendShapeDataTexture.filterMode = exports.TextureFilterMode.Point;
...
var ModelMesh = /*#__PURE__*/function (_Mesh) {
  ...
  _proto._updateVertexElements = function _updateVertexElements() {
    ...
    if (this._vertexSlotChanged || attributeMode && blendShapeManager._vertexElementsNeedUpdate()) {
      ...
      if (this._colors) {
        this._addVertexElement(new VertexElement("COLOR_0", offset, exports.VertexElementFormat.Vector4, 0));
        offset += 16;
        elementCount += 4;
      }
      if (this._boneWeights) {
        this._addVertexElement(new VertexElement("WEIGHTS_0", offset, exports.VertexElementFormat.Vector4, 0));
        offset += 16;
        elementCount += 4;
      }
      if (this._boneIndices) {
        this._addVertexElement(new VertexElement("JOINTS_0", offset, exports.VertexElementFormat.UByte4, 0));
        offset += 4;
        elementCount += 1;
      }
      if (this._tangents) {
        this._addVertexElement(new VertexElement("TANGENT", offset, exports.VertexElementFormat.Vector4, 0));
        offset += 16;
        elementCount += 4;
      }
      if (this._uv) {
      ...
      if (this._uv1) {
        this._addVertexElement(new VertexElement("TEXCOORD_1", offset, exports.VertexElementFormat.Vector2, 0));
        offset += 8;
        elementCount += 2;
      }
      if (this._uv2) {
        this._addVertexElement(new VertexElement("TEXCOORD_2", offset, exports.VertexElementFormat.Vector2, 0));
        offset += 8;
        elementCount += 2;
      }
      if (this._uv3) {
        this._addVertexElement(new VertexElement("TEXCOORD_3", offset, exports.VertexElementFormat.Vector2, 0));
        offset += 8;
        elementCount += 2;
      }
      if (this._uv4) {
        this._addVertexElement(new VertexElement("TEXCOORD_4", offset, exports.VertexElementFormat.Vector2, 0));
        offset += 8;
        elementCount += 2;
      }
      if (this._uv5) {
        this._addVertexElement(new VertexElement("TEXCOORD_5", offset, exports.VertexElementFormat.Vector2, 0));
        offset += 8;
        elementCount += 2;
      }
      if (this._uv6) {
        this._addVertexElement(new VertexElement("TEXCOORD_6", offset, exports.VertexElementFormat.Vector2, 0));
        offset += 8;
        elementCount += 2;
      }
      if (this._uv7) {
        this._addVertexElement(new VertexElement("TEXCOORD_7", offset, exports.VertexElementFormat.Vector2, 0));
        offset += 8;
        elementCount += 2;
      }
      if (attributeMode) {
...
var PrimitiveMesh = /*#__PURE__*/function () {
  ...
  PrimitiveMesh.createSphere = function createSphere(engine, radius, segments, noLongerAccessible) {
    ...
    for (var i = 0; i < vertexCount; ++i) {
      ...
      // Position
      positions[i] = new miniprogram.Vector3(posX, posY, posZ);
      // Normal
      normals[i] = new miniprogram.Vector3(posX, posY, posZ);
      // Texcoord
  ...
  PrimitiveMesh.createCuboid = function createCuboid(engine, width, height, depth, noLongerAccessible) {
    ...
    uvs[3] = new miniprogram.Vector2(0, 1);
    // Down
    ...
    uvs[7] = new miniprogram.Vector2(0, 0);
    // Left
    ...
    uvs[11] = new miniprogram.Vector2(0, 1);
    // Right
    ...
    uvs[15] = new miniprogram.Vector2(1, 1);
    // Front
    ...
    uvs[19] = new miniprogram.Vector2(0, 1);
    // Back
  ...
  PrimitiveMesh.createPlane = function createPlane(engine, width, height, horizontalSegments, verticalSegments, noLongerAccessible) {
    ...
    for (var i = 0; i < vertexCount; ++i) {
      ...
      // Position
      positions[i] = new miniprogram.Vector3(x * gridWidth - halfWidth, 0, z * gridHeight - halfHeight);
      // Normal
      normals[i] = new miniprogram.Vector3(0, 1, 0);
      // Texcoord
  ...
  PrimitiveMesh.createCylinder = function createCylinder(engine, radiusTop, radiusBottom, height, radialSegments, heightSegments, noLongerAccessible) {
    ...
    for (var i = 0; i < torsoVertexCount; ++i) {
      ...
      positions[i] = new miniprogram.Vector3(posX, posY, posZ);
      // Normal
      normals[i] = new miniprogram.Vector3(sinTheta, slope, cosTheta);
      // Texcoord
    ...
    // Bottom position
    positions[torsoVertexCount] = new miniprogram.Vector3(0, -halfHeight, 0);
    // Bottom normal
    normals[torsoVertexCount] = new miniprogram.Vector3(0, -1, 0);
    // Bottom texcoord
    uvs[torsoVertexCount] = new miniprogram.Vector2(0.5, 0.5);

    // Top position
    positions[torsoVertexCount + 1] = new miniprogram.Vector3(0, halfHeight, 0);
    // Top normal
    normals[torsoVertexCount + 1] = new miniprogram.Vector3(0, 1, 0);
    // Top texcoord
    uvs[torsoVertexCount + 1] = new miniprogram.Vector2(0.5, 0.5);
    ...
    for (var _i4 = 0; _i4 < radialSegments; ++_i4) {
      ...
      // Bottom position
      positions[offset] = new miniprogram.Vector3(curPosX, -halfHeight, curPosZ);
      // Bottom normal
      normals[offset] = new miniprogram.Vector3(0, -1, 0);
      // Bottom texcoord
  ...
  PrimitiveMesh._createCapsuleCap = function _createCapsuleCap(radius, height, radialSegments, capAlphaRange, offset, posIndex, positions, normals, uvs, indices, indicesOffset) {
    ...
    for (var i = 0; i < capVertexCount; ++i) {
      ...
      normals[index] = new miniprogram.Vector3(posX, posY - halfHeight, posZ);
...
})(exports.BackgroundTextureFillMode || (exports.BackgroundTextureFillMode = {}));
...
var Background = /*#__PURE__*/function () {
  ...
  function Background(_engine) {
    ...
    this.sky = new Sky();
    this._textureFillMode = exports.BackgroundTextureFillMode.AspectFitHeight;
    this._mesh = void 0;
    this._texture = null;
...
var Engine = /*#__PURE__*/function (_EventDispatcher) {
  ...
  function Engine(canvas, hardwareRenderer, settings) {
    ...
    magentaTextureCube.setPixelBuffer(exports.TextureCubeFace.NegativeY, magentaPixel);
    magentaTextureCube.setPixelBuffer(exports.TextureCubeFace.PositiveZ, magentaPixel);
    magentaTextureCube.setPixelBuffer(exports.TextureCubeFace.NegativeZ, magentaPixel);
    ...
    magentaMaterial.shaderData.setColor("u_baseColor", new miniprogram.Color(1.0, 0.0, 1.01, 1.0));
  ...
  _proto.resume = function resume() {
    ...
    this.time.reset();
    this._requestId = miniprogramAdapter.requestAnimationFrame(this._animate);
  }
...
Engine._defaultBoundingBox = new miniprogram.BoundingBox(new miniprogram.Vector3(0, 0, 0), new miniprogram.Vector3(0, 0, 0));
...
var BasicRenderPipeline = /*#__PURE__*/function () {
  ...
  _proto._drawRenderPass = function _drawRenderPass(pass, camera, cubeFace, mipLevel) {
    ...
    if (pass.enabled) {
      ...
      if (pass.renderOverride) {
        ...
        if (camera.clearFlags & exports.CameraClearFlags.Color) {
  ...
  _proto.pushPrimitive = function pushPrimitive(element) {
    switch (element.material.renderQueueType) {
      case exports.RenderQueueType.Transparent:
        this._transparentQueue.pushPrimitive(element);
        break;
      case exports.RenderQueueType.AlphaTest:
        this._alphaTestQueue.pushPrimitive(element);
        break;
      case exports.RenderQueueType.Opaque:
...
var Camera = (_dec$1 = dependentComponents(Transform), _dec$1(_class$4 = (_class2$4 = (_class3 = /*#__PURE__*/function (_Component) {
  ...
  function Camera(entity) {
    ...
    _this.clearFlags = exports.CameraClearFlags.All;
  ...
  _createClass(Camera, [{
    ...
    get: function get() {
      if (this._isViewMatrixDirty.flag) {
        ...
        // Ignore scale.
        miniprogram.Matrix.rotationTranslation(this._transform.worldRotationQuaternion, this._transform.worldPosition, this._viewMatrix);
...
function requestImage(url, config) {
  return new AssetPromise(function (resolve, reject) {
    ...
    var timeoutId = -1;
    if (timeout != Infinity) {
      timeoutId = miniprogramAdapter.window.setTimeout(function () {
...
var PBRBaseMaterial = /*#__PURE__*/function (_BaseMaterial) {
  ...
  function PBRBaseMaterial(engine, shader) {
    ...
    shaderData.setFloat(PBRBaseMaterial._occlusionTextureCoordProp, exports.TextureCoordinate.UV0);
  ...
  _createClass(PBRBaseMaterial, [{
    ...
    set: function set(value) {
      if (value > exports.TextureCoordinate.UV1) {
...
})(exports.SpriteDrawMode || (exports.SpriteDrawMode = {}));
...
var Sprite = /*#__PURE__*/function (_RefObject) {
  ...
  function Sprite(engine, texture, region, pivot, border, name) {
    ...
    _this._uvs = [new miniprogram.Vector2(), new miniprogram.Vector2(), new miniprogram.Vector2(), new miniprogram.Vector2()];
...
}(), _class2$3._worldMatrix = new miniprogram.Matrix(), _class2$3)) || _class$3);
  ...
  _proto._onSpriteChange = function _onSpriteChange(dirtyFlag) {
    switch (dirtyFlag) {
      ...
      case SpritePropertyDirtyFlag.size:
        this._drawMode === exports.SpriteDrawMode.Sliced && (this._dirtyFlag |= DirtyFlag$1.Position);
        break;
      case SpritePropertyDirtyFlag.border:
        this._drawMode === exports.SpriteDrawMode.Sliced && (this._dirtyFlag |= DirtyFlag$1.All);
        break;
      case SpritePropertyDirtyFlag.region:
      case SpritePropertyDirtyFlag.atlasRegionOffset:
  ...
  _createClass(SpriteRenderer, [{
    ...
    set: function set(drawMode) {
      if (this._drawMode !== drawMode) {
        ...
        switch (drawMode) {
          case exports.SpriteDrawMode.Simple:
            this._assembler = SimpleSpriteAssembler;
            break;
          case exports.SpriteDrawMode.Sliced:
...
function CharRenderData() {
  this.texture = void 0;
  this.localPositions = new miniprogram.Vector4();
  this.renderData = void 0;
  var positions = [new miniprogram.Vector3(), new miniprogram.Vector3(), new miniprogram.Vector3(), new miniprogram.Vector3()];
...
var TextUtils = /*#__PURE__*/function () {
  ...
  TextUtils.textContext = function textContext() {
    ...
    if (!textContext) {
      var canvas;
      try {
        canvas = new miniprogramAdapter.OffscreenCanvas(0, 0);
      } catch (_unused) {
        canvas = miniprogramAdapter.document.createElement("canvas");
      }
  ...
  TextUtils.getNativeFontString = function getNativeFontString(fontName, fontSize, style) {
    var str = style & exports.FontStyle.Bold ? "bold " : "";
    style & exports.FontStyle.Italic && (str += "italic ");
  ...
  TextUtils._measureFontOrChar = function _measureFontOrChar(fontString, char) {
    ...
    if (char) {
      ...
      return {
        ...
        xAdvance: width,
        uvs: [new miniprogram.Vector2(), new miniprogram.Vector2(), new miniprogram.Vector2(), new miniprogram.Vector2()],
        ascent: ascent,
        descent: descent,
        index: 0,
        data: data
...
var TextRenderer = (_class$1 = (_class2$1 = /*#__PURE__*/function (_Renderer) {
  ...
  _proto._updatePosition = function _updatePosition() {
    ...
    for (var i = 0, n = charRenderDatas.length; i < n; ++i) {
      ...
      miniprogram.Vector3.scale(right, localPositions.z - topLeftX, worldPosition1);

      // Top-Right
      miniprogram.Vector3.add(worldPosition0, worldPosition1, worldPosition1);

      // Up offset
      var worldPosition2 = positions[2];
      miniprogram.Vector3.scale(up, localPositions.w - topLeftY, worldPosition2);

      // Bottom-Left
      miniprogram.Vector3.add(worldPosition0, worldPosition2, positions[3]);
      // Bottom-Right
      miniprogram.Vector3.add(worldPosition1, worldPosition2, worldPosition2);
    }
  };
  ...
  return TextRenderer;
}(Renderer), _class2$1._charRenderDataPool = new CharRenderDataPool(CharRenderData, 50), _class2$1._tempVec30 = new miniprogram.Vector3(), _class2$1._tempVec31 = new miniprogram.Vector3(), _class2$1), (_descriptor$1 = _applyDecoratedDescriptor(_class$1.prototype, "_styleFont", [assignmentClone], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
  ...
  writable: true,
  initializer: function initializer() {
    return exports.TextHorizontalAlignment.Center;
  }
  ...
  writable: true,
  initializer: function initializer() {
    return exports.TextVerticalAlignment.Center;
  }
  ...
  writable: true,
  initializer: function initializer() {
    return exports.OverflowMode.Overflow;
  }
...
var AnimatorTempValue = /*#__PURE__*/function () {
  function AnimatorTempValue() {
    this.vector2 = new miniprogram.Vector2();
    this.vector3 = new miniprogram.Vector3();
    this.vector4 = new miniprogram.Vector4();
    this.quaternion = new miniprogram.Quaternion();
...
var Animator = (_class = (_class2 = /*#__PURE__*/function (_Component) {
      ...
      case exports.InterpolableValueType.Vector2:
        {
          ...
          if (additive) {
            if (property === exports.AnimationProperty.Scale) {
              miniprogram.Vector2.divide(_value2, baseValue, _value2);
            } else {
              miniprogram.Vector2.subtract(_value2, baseValue, _value2);
            }
          }
          return _value2;
        }
      case exports.InterpolableValueType.Vector3:
        {
          ...
          if (additive) {
            if (property === exports.AnimationProperty.Scale) {
              miniprogram.Vector3.divide(_value3, baseValue, _value3);
            } else {
              miniprogram.Vector3.subtract(_value3, baseValue, _value3);
            }
          }
          return _value3;
        }
      case exports.InterpolableValueType.Vector4:
        {
          var _value4 = tempValue.vector4;
          curve._evaluate(time, _value4);
          if (additive) {
            miniprogram.Vector4.subtract(_value4, baseValue, _value4);
          }
          return _value4;
        }
      case exports.InterpolableValueType.Quaternion:
        {
          ...
          if (additive) {
            ...
            miniprogram.Quaternion.conjugate(baseValue, tempQuat);
            miniprogram.Quaternion.multiply(tempQuat, _value5, _value5);
          }
          return _value5;
        }
    }
    ...
    if (owner.type === Transform) {
      switch (owner.property) {
        case exports.AnimationProperty.Position:
          ...
          miniprogram.Vector3.lerp(srcValue, destValue, crossWeight, value);
          break;
        case exports.AnimationProperty.Rotation:
          value = this._baseTempValue.quaternion;
          miniprogram.Quaternion.slerp(srcValue, destValue, crossWeight, value);
          break;
        case exports.AnimationProperty.Scale:
          {
            value = this._baseTempValue.vector3;
  ...
  return Animator;
}(Component), _class2._tempQuat = new miniprogram.Quaternion(), _class2._animatorInfo = new AnimatorStateInfo(), _class2), (_descriptor = _applyDecoratedDescriptor(_class.prototype, "_speed", [assignmentClone], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
  ...
  _proto._evaluateLinear = function _evaluateLinear(frameIndex, nextFrameIndex, t, out) {
    ...
    switch (_valueType) {
      ...
      case exports.InterpolableValueType.FloatArray:
        ...
        return out;
      case exports.InterpolableValueType.Vector2:
        miniprogram.Vector2.lerp(keys[frameIndex].value, keys[nextFrameIndex].value, t, out);
        return out;
      case exports.InterpolableValueType.Vector3:
        miniprogram.Vector3.lerp(keys[frameIndex].value, keys[nextFrameIndex].value, t, out);
        return out;
      case exports.InterpolableValueType.Vector4:
        miniprogram.Vector4.lerp(keys[frameIndex].value, keys[nextFrameIndex].value, t, out);
        return out;
      case exports.InterpolableValueType.Quaternion:
        miniprogram.Quaternion.slerp(keys[frameIndex].value, keys[nextFrameIndex].value, t, out);
        return out;
    }
  };
...
var TrailRenderer = /*#__PURE__*/function (_MeshRenderer) {
  ...
  _proto.update = function update(deltaTime) {
    ...
    if (this._curPointNum === this._maxPointNum) {
      ...
      if (miniprogram.Vector3.distance(this.entity.transform.worldPosition, lastPoint) < this._minSeg) {
        appendNewPoint = false;
      }
    }
    if (appendNewPoint) {
...
var Probe = /*#__PURE__*/function (_Script) {
  ...
  _proto.onBeginRender = function onBeginRender(camera) {
    ...
    if (!this._activeRenderTarget || this._activeRenderTarget.width !== this.width || this._activeRenderTarget.height !== this.height || this._activeRenderTarget.antiAliasing !== this.antiAliasing) {
      this._renderTarget = new RenderTarget(this.engine, this.width, this.height, this._isCube ? new TextureCube(this.engine, this.width) : new Texture2D(this.engine, this.width, this.height), exports.RenderBufferDepthFormat.Depth, this.antiAliasing);
      this._renderTargetSwap = new RenderTarget(this.engine, this.width, this.height, this._isCube ? new TextureCube(this.engine, this.width) : new Texture2D(this.engine, this.width, this.height), exports.RenderBufferDepthFormat.Depth, this.antiAliasing);
...
var ShadowFeature = /*#__PURE__*/function (_SceneFeature) {
  ...
  _proto.addShadowMapPass = function addShadowMapPass(camera, light) {
    ...
    var shadowMapPass = new ShadowMapPass("ShadowMapPass", -1, light.shadow.renderTarget, this._shadowMapMaterial, exports.Layer.Layer31,
    // SHADOW_MAP
    light);
    var renderer = camera._renderPipeline;
