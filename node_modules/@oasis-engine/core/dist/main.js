...
var Transform = (_class$d = (_class2$b = /*#__PURE__*/function (_Component) {
  ...
  _proto.lookAt = function lookAt(targetPosition, worldUp) {
    ...
    math.Vector3.subtract(this.worldPosition, targetPosition, zAxis);
    var axisLen = zAxis.length();
    if (axisLen <= math.MathUtil.zeroTolerance) {
    ...
    if (worldUp) {
      math.Vector3.cross(worldUp, zAxis, xAxis);
    } else {
    ...
    math.Vector3.cross(zAxis, xAxis, yAxis);
  ...
  _proto._rotateByQuat = function _rotateByQuat(rotateQuat, relativeToLocal) {
    if (relativeToLocal) {
      ...
      math.Quaternion.multiply(rotateQuat, this.worldRotationQuaternion, this._worldRotationQuaternion);
    }
  };
  _proto._translate = function _translate(translation, relativeToLocal) {
    ...
    if (relativeToLocal) {
      ...
      math.Vector3.transformByQuat(translation, this.worldRotationQuaternion, _tempVec30);
  ...
  _proto._onWorldPositionChanged = function _onWorldPositionChanged() {
    ...
    if (parent) {
      ...
      math.Vector3.transformCoordinate(worldPosition, Transform._tempMat41, this._position);
    } else {
  ...
  _proto._onWorldRotationChanged = function _onWorldRotationChanged() {
    ...
    math.Quaternion.rotationEuler(math.MathUtil.degreeToRadian(worldRotation.x), math.MathUtil.degreeToRadian(worldRotation.y), math.MathUtil.degreeToRadian(worldRotation.z), this._worldRotationQuaternion);
  ...
  _proto._onWorldRotationQuaternionChanged = function _onWorldRotationQuaternionChanged() {
    ...
    if (parent) {
      ...
      math.Quaternion.invert(parent.worldRotationQuaternion, invParentQuaternion);
      math.Quaternion.multiply(invParentQuaternion, worldRotationQuaternion, this._rotationQuaternion);
    } else {
  ...
  _createClass(Transform, [{
    ...
    get: function get() {
      ...
      if (this._isContainDirtyFlag(TransformFlag.LocalEuler)) {
        ...
        rotation.scale(math.MathUtil.radToDegreeFactor); // radians to degrees
        this._setDirtyFlagFalse(TransformFlag.LocalEuler);
      }
      return rotation;
    },
    ...
    get: function get() {
      ...
      if (this._isContainDirtyFlag(TransformFlag.WorldEuler)) {
        ...
        worldRotation.scale(math.MathUtil.radToDegreeFactor); // Radian to angle
        //@ts-ignore
    ...
    get: function get() {
      ...
      if (this._isContainDirtyFlag(TransformFlag.LocalQuat)) {
        ...
        math.Quaternion.rotationEuler(math.MathUtil.degreeToRadian(this._rotation.x), math.MathUtil.degreeToRadian(this._rotation.y), math.MathUtil.degreeToRadian(this._rotation.z), rotationQuaternion);
        //@ts-ignore
    ...
    set: function set(value) {
      if (this._rotationQuaternion !== value) {
        if (value.normalized) {
          ...
          math.Quaternion.normalize(value, this._rotationQuaternion);
        }
      } else {
    ...
    get: function get() {
      ...
      if (this._isContainDirtyFlag(TransformFlag.WorldQuat)) {
        ...
        var parent = this._getParentTransform();
        if (parent != null) {
          math.Quaternion.multiply(parent.worldRotationQuaternion, this.rotationQuaternion, worldRotationQuaternion);
        } else {
    ...
    set: function set(value) {
      if (this._worldRotationQuaternion !== value) {
        if (value.normalized) {
          ...
          math.Quaternion.normalize(value, this._worldRotationQuaternion);
        }
      }
      value.normalized || value.normalize();
    }
    ...
    set: function set(value) {
      ...
      if (parent) {
        ...
        math.Matrix.multiply(Transform._tempMat42, value, this._localMatrix);
      } else {
        this._localMatrix.copyFrom(value);
      }
  ...
  return Transform;
}(Component), _class2$b._tempQuat0 = new math.Quaternion(), _class2$b._tempVec30 = new math.Vector3(), _class2$b._tempVec31 = new math.Vector3(), _class2$b._tempVec32 = new math.Vector3(), _class2$b._tempMat30 = new math.Matrix3x3(), _class2$b._tempMat31 = new math.Matrix3x3(), _class2$b._tempMat32 = new math.Matrix3x3(), _class2$b._tempMat41 = new math.Matrix(), _class2$b._tempMat42 = new math.Matrix(), _class2$b), (_descriptor$a = _applyDecoratedDescriptor(_class$d.prototype, "_position", [deepClone], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
var PhysicsManager = /*#__PURE__*/function () {
  function PhysicsManager(engine) {
    ...
    this._gravity = new math.Vector3(0, -9.81, 0);
...
var CharacterController = /*#__PURE__*/function (_Collider) {
  ...
  function CharacterController(entity) {
    ...
    _this._upDirection = new math.Vector3(0, 1, 0);
    _this._slopeLimit = 0;
...
var Joint = (_dec$4 = dependentComponents(Collider), _dec$4(_class$b = /*#__PURE__*/function (_Component) {
  ...
  function Joint(entity) {
    ...
    _this._force = 0;
    _this._torque = 0;
    _this._connectedCollider.localPosition = new math.Vector3();
    return _this;
  }
  _createClass(Joint, [{
...
var HingeJoint = /*#__PURE__*/function (_Joint) {
  ...
  function HingeJoint() {
    ...
    _this._axis = new math.Vector3(1, 0, 0);
    _this._hingeFlags = 0;
  ...
  _proto._onAwake = function _onAwake() {
    var collider = this._collider;
    collider.localPosition = new math.Vector3();
    collider.collider = this.entity.getComponent(Collider);
...
var DynamicCollider = /*#__PURE__*/function (_Collider) {
  ...
  function DynamicCollider(entity) {
    ...
    _this._linearVelocity = new math.Vector3();
    _this._angularVelocity = new math.Vector3();
    _this._mass = 0;
    _this._centerOfMass = new math.Vector3();
    _this._inertiaTensor = new math.Vector3();
...
var PointerManager = /*#__PURE__*/function () {
  ...
  function PointerManager(engine, htmlCanvas) {
    this._pointers = [];
    this._movingDelta = new math.Vector2();
...
var SimpleSpriteAssembler = (_dec$2 = StaticInterfaceImplement(), _dec$2(_class$9 = (_class2$8 = /*#__PURE__*/function () {
  ...
  SimpleSpriteAssembler.resetData = function resetData(renderer) {
    ...
    if (positions.length < vertexCount) {
      for (var i = positions.length; i < vertexCount; i++) {
        positions.push(new math.Vector3());
        uvs.push(new math.Vector2());
      }
    }
  ...
  SimpleSpriteAssembler.updatePositions = function updatePositions(renderer) {
    ...
    math.BoundingBox.transform(sprite._getBounds(), worldMatrix, renderer._bounds);
  };
...
}(), _class2$8._rectangleTriangles = [0, 1, 2, 2, 1, 3], _class2$8._worldMatrix = new math.Matrix(), _class2$8)) || _class$9);
...
var BlendShapeManager = /*#__PURE__*/function () {
  ...
  function BlendShapeManager(engine, modelMesh) {
    ...
    this._lastCreateHostInfo = new math.Vector3(0, 0, 0);
    this._canUseTextureStoreData = true;
    this._dataTextureInfo = new math.Vector3();
    this._engine = engine;
  ...
  _proto._updateVertexBuffers = function _updateVertexBuffers(vertexCount, force) {
    ...
    for (var i = 0, n = blendShapes.length; i < n; i++) {
      ...
      if (force || dataChangedFlag.flag) {
        ...
        storeInfo || (storeInfos[i] = storeInfo = new math.Vector2());
...
var PrimitiveMesh = /*#__PURE__*/function () {
  ...
  PrimitiveMesh.createSphere = function createSphere(engine, radius, segments, noLongerAccessible) {
    ...
    for (var i = 0; i < vertexCount; ++i) {
      ...
      // Position
      positions[i] = new math.Vector3(posX, posY, posZ);
      // Normal
      normals[i] = new math.Vector3(posX, posY, posZ);
      // Texcoord
  ...
  PrimitiveMesh.createPlane = function createPlane(engine, width, height, horizontalSegments, verticalSegments, noLongerAccessible) {
    ...
    for (var i = 0; i < vertexCount; ++i) {
      ...
      // Position
      positions[i] = new math.Vector3(x * gridWidth - halfWidth, 0, z * gridHeight - halfHeight);
      // Normal
      normals[i] = new math.Vector3(0, 1, 0);
      // Texcoord
  ...
  PrimitiveMesh.createCylinder = function createCylinder(engine, radiusTop, radiusBottom, height, radialSegments, heightSegments, noLongerAccessible) {
    ...
    for (var i = 0; i < torsoVertexCount; ++i) {
      ...
      positions[i] = new math.Vector3(posX, posY, posZ);
      // Normal
      normals[i] = new math.Vector3(sinTheta, slope, cosTheta);
      // Texcoord
    ...
    // Bottom position
    positions[torsoVertexCount] = new math.Vector3(0, -halfHeight, 0);
    // Bottom normal
    normals[torsoVertexCount] = new math.Vector3(0, -1, 0);
    // Bottom texcoord
    uvs[torsoVertexCount] = new math.Vector2(0.5, 0.5);

    // Top position
    positions[torsoVertexCount + 1] = new math.Vector3(0, halfHeight, 0);
    // Top normal
    normals[torsoVertexCount + 1] = new math.Vector3(0, 1, 0);
    // Top texcoord
    uvs[torsoVertexCount + 1] = new math.Vector2(0.5, 0.5);
    ...
    for (var _i4 = 0; _i4 < radialSegments; ++_i4) {
      ...
      // Bottom position
      positions[offset] = new math.Vector3(curPosX, -halfHeight, curPosZ);
      // Bottom normal
      normals[offset] = new math.Vector3(0, -1, 0);
      // Bottom texcoord
  ...
  PrimitiveMesh._createCapsuleCap = function _createCapsuleCap(radius, height, radialSegments, capAlphaRange, offset, posIndex, positions, normals, uvs, indices, indicesOffset) {
    ...
    for (var i = 0; i < capVertexCount; ++i) {
      ...
      normals[index] = new math.Vector3(posX, posY - halfHeight, posZ);
...
var Engine = /*#__PURE__*/function (_EventDispatcher) {
  ...
  function Engine(canvas, hardwareRenderer, settings) {
    ...
    magentaMaterial.shaderData.setColor("u_baseColor", new math.Color(1.0, 0.0, 1.01, 1.0));
...
Engine._defaultBoundingBox = new math.BoundingBox(new math.Vector3(0, 0, 0), new math.Vector3(0, 0, 0));
  ...
  _createClass(Camera, [{
    ...
    get: function get() {
      if (this._isViewMatrixDirty.flag) {
        ...
        // Ignore scale.
        math.Matrix.rotationTranslation(this._transform.worldRotationQuaternion, this._transform.worldPosition, this._viewMatrix);
...
var BlinnPhongMaterial = /*#__PURE__*/function (_BaseMaterial) {
  ...
  function BlinnPhongMaterial(engine) {
    ...
    shaderData.setColor(BlinnPhongMaterial._baseColorProp, new math.Color(1, 1, 1, 1));
...
var Sprite = /*#__PURE__*/function (_RefObject) {
  ...
  function Sprite(engine, texture, region, pivot, border, name) {
    ...
    _this._uvs = [new math.Vector2(), new math.Vector2(), new math.Vector2(), new math.Vector2()];
    ...
    _this._border = new math.Vector4(0, 0, 0, 0);
  ...
  _createClass(Sprite, [{
    ...
    set: function set(value) {
      ...
      this._atlasRegion.set(x, y, math.MathUtil.clamp(value.width, 0, 1 - x), math.MathUtil.clamp(value.height, 0, 1 - y));
    ...
    set: function set(value) {
      var x = math.MathUtil.clamp(value.x, 0, 1);
      var y = math.MathUtil.clamp(value.y, 0, 1);
      this._atlasRegionOffset.set(x, y, math.MathUtil.clamp(value.z, 0, 1 - x), math.MathUtil.clamp(value.w, 0, 1 - y));
    ...
    set: function set(value) {
      ...
      var x = math.MathUtil.clamp(value.x, 0, 1);
      var y = math.MathUtil.clamp(value.y, 0, 1);
      region.set(x, y, math.MathUtil.clamp(value.width, 0, 1 - x), math.MathUtil.clamp(value.height, 0, 1 - y));
    ...
    set: function set(value) {
      ...
      var x = math.MathUtil.clamp(value.x, 0, 1);
      var y = math.MathUtil.clamp(value.y, 0, 1);
      border.set(x, y, math.MathUtil.clamp(value.z, 0, 1 - x), math.MathUtil.clamp(value.w, 0, 1 - y));
...
}(), _class2$3._worldMatrix = new math.Matrix(), _class2$3)) || _class$3);
...
function CharRenderData() {
  this.texture = void 0;
  this.localPositions = new math.Vector4();
  this.renderData = void 0;
  var positions = [new math.Vector3(), new math.Vector3(), new math.Vector3(), new math.Vector3()];
  ...
  TextUtils._measureFontOrChar = function _measureFontOrChar(fontString, char) {
    ...
    if (char) {
      ...
      return {
        ...
        xAdvance: width,
        uvs: [new math.Vector2(), new math.Vector2(), new math.Vector2(), new math.Vector2()],
        ascent: ascent,
        descent: descent,
        index: 0,
        data: data
...
var TextRenderer = (_class$1 = (_class2$1 = /*#__PURE__*/function (_Renderer) {
   ...
   */;
  _proto._updateBounds = function _updateBounds(worldBounds) {
    math.BoundingBox.transform(this._localBounds, this._entity.transform.worldMatrix, worldBounds);
  };
  _proto._updateStencilState = function _updateStencilState() {
    // Update stencil.
    var material = this.getInstanceMaterial();
  ...
  _proto._updatePosition = function _updatePosition() {
    ...
    for (var i = 0, n = charRenderDatas.length; i < n; ++i) {
      ...
      math.Vector3.scale(right, localPositions.z - topLeftX, worldPosition1);

      // Top-Right
      math.Vector3.add(worldPosition0, worldPosition1, worldPosition1);

      // Up offset
      var worldPosition2 = positions[2];
      math.Vector3.scale(up, localPositions.w - topLeftY, worldPosition2);

      // Bottom-Left
      math.Vector3.add(worldPosition0, worldPosition2, positions[3]);
      // Bottom-Right
      math.Vector3.add(worldPosition1, worldPosition2, worldPosition2);
    }
  };
  ...
  return TextRenderer;
}(Renderer), _class2$1._charRenderDataPool = new CharRenderDataPool(CharRenderData, 50), _class2$1._tempVec30 = new math.Vector3(), _class2$1._tempVec31 = new math.Vector3(), _class2$1), (_descriptor$1 = _applyDecoratedDescriptor(_class$1.prototype, "_styleFont", [assignmentClone], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
var AnimatorTempValue = /*#__PURE__*/function () {
  function AnimatorTempValue() {
    this.vector2 = new math.Vector2();
    this.vector3 = new math.Vector3();
    this.vector4 = new math.Vector4();
...
var Animator = (_class = (_class2 = /*#__PURE__*/function (_Component) {
      ...
      case exports.InterpolableValueType.Vector2:
        {
          ...
          if (additive) {
            if (property === exports.AnimationProperty.Scale) {
              math.Vector2.divide(_value2, baseValue, _value2);
            } else {
              math.Vector2.subtract(_value2, baseValue, _value2);
            }
          }
          return _value2;
        }
      case exports.InterpolableValueType.Vector3:
        {
          ...
          if (additive) {
            if (property === exports.AnimationProperty.Scale) {
              math.Vector3.divide(_value3, baseValue, _value3);
            } else {
              math.Vector3.subtract(_value3, baseValue, _value3);
            }
          }
          return _value3;
        }
      case exports.InterpolableValueType.Vector4:
        {
          ...
          if (additive) {
            math.Vector4.subtract(_value4, baseValue, _value4);
          }
          return _value4;
        }
      case exports.InterpolableValueType.Quaternion:
        {
          ...
          if (additive) {
            ...
            math.Quaternion.conjugate(baseValue, tempQuat);
            math.Quaternion.multiply(tempQuat, _value5, _value5);
          }
          return _value5;
        }
    }
    ...
    if (owner.type === Transform) {
      switch (owner.property) {
        case exports.AnimationProperty.Position:
          ...
          math.Vector3.lerp(srcValue, destValue, crossWeight, value);
          break;
        case exports.AnimationProperty.Rotation:
          value = this._baseTempValue.quaternion;
          math.Quaternion.slerp(srcValue, destValue, crossWeight, value);
          break;
        case exports.AnimationProperty.Scale:
          {
            value = this._baseTempValue.vector3;
  ...
  return Animator;
}(Component), _class2._tempQuat = new math.Quaternion(), _class2._animatorInfo = new AnimatorStateInfo(), _class2), (_descriptor = _applyDecoratedDescriptor(_class.prototype, "_speed", [assignmentClone], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
  ...
  _proto._evaluateLinear = function _evaluateLinear(frameIndex, nextFrameIndex, t, out) {
    ...
    switch (_valueType) {
      ...
      case exports.InterpolableValueType.FloatArray:
        ...
        return out;
      case exports.InterpolableValueType.Vector2:
        math.Vector2.lerp(keys[frameIndex].value, keys[nextFrameIndex].value, t, out);
        return out;
      case exports.InterpolableValueType.Vector3:
        math.Vector3.lerp(keys[frameIndex].value, keys[nextFrameIndex].value, t, out);
        return out;
      case exports.InterpolableValueType.Vector4:
        math.Vector4.lerp(keys[frameIndex].value, keys[nextFrameIndex].value, t, out);
        return out;
      case exports.InterpolableValueType.Quaternion:
        math.Quaternion.slerp(keys[frameIndex].value, keys[nextFrameIndex].value, t, out);
        return out;
    }
  };
...
var TrailRenderer = /*#__PURE__*/function (_MeshRenderer) {
  ...
  _proto.update = function update(deltaTime) {
    ...
    if (this._curPointNum === this._maxPointNum) {
      ...
      if (math.Vector3.distance(this.entity.transform.worldPosition, lastPoint) < this._minSeg) {
        appendNewPoint = false;
      }
    }
    if (appendNewPoint) {
